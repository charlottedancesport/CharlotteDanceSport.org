...
function post_email_to_cds_officer ($senders_name, $senders_email, $message_topic, $message, $city, $country, $country_code, $region, $latitude, $longitude) {
    if(isset($_GET['type']) && $_GET['type'] == 'cdc'){} else {
	...
	if(isset($_GET['type']) && $_GET['type'] == 'cdc'){
		$to = '';
		if( $message_topic == "Housing" ) $to .= ",kevin.schlitter@gmail.com,zapata.christine@gmail.com";
		if( $message_topic == "Organizer" ) $to .= ",pala.okan@gmail.com";
		if( $message_topic == "Media" ) $to .= ",hilarycammack@gmail.com";
		if( $message_topic == "Registration" ) $to .= ",pala.okan@gmail.com";
		if( $message_topic == "General Question" ) $to .= ",pala.okan@gmail.com";
		if( $message_topic == "Sponsors" ) $to .= ",pala.okan@gmail.com";
		if( $message_topic == "Volunteers" ) $to .= ",pala.okan@gmail.com";
		$sendMail = mail("charlottedancesport+webform@gmail.com".$to, "CDSC 2011 - Message from $senders_name", $message, $headers);
	} else {
        ...
        <div id="ContactCDS_Form">
        	<div id="contactus_form_container">
                ...
                <div id="message_topic">
                    ...
                    <li id="Organizer">Dear Organizer</li>
                    <li id="Registration">Registration</li>
                    <li id="Sponsors">Sponsorship/Vendors</li>
                    <li id="Volunteers">Volunteers</li>
